...
function changeAvatar(name) {
    if (name == ""){
        y = ["Default.png"];
        localStorage.setItem ("avatarVAR",y);
        return;
    }
    document.getElementById("avatar").src = name;
    localStorage.setItem ("avatarVAR", name);
}

function changePath(name) {
    if (name == ""){
        x = ["#000000"];
        localStorage.setItem ("pathcolors",x);
        return;
    }
    ...
    const colorSchemes = {
      default: ["#000000"],
        ...
        'paths/Rectangle 6.png': [
            "#8B0030", // Deep Dark Pink
            "#A00044",
            "#B40058",
            "#C8006C",
            "#DC0080", // Strong Pink
        ...
        'paths/Rectangle 7.png': [
            "#FFFF00", // Pure Yellow
            "#FFEA60", // Soft Golden Yellow
            "#FFE080",
            "#FFD8A0",
            "#FFE8C0",
            "#FFF0E0",
            "#FFFFFF", // Pure White
            "#E8D8FF", // Soft Lavender
            "#D0B0FF", // Light Purple
            "#B890FF",
            "#A070FF",
            "#9048FF",
